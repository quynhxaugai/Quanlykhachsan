...
----------------------------------------------------------------------------------------
go
Create Proc [dbo].[suanv]  --N'Nguyễn Văn Phước',N'Nam',N'Biên Hòa, Đồng Nai',N'1/03/1993',123456789,N'admin',N'admin'
@hoten Nvarchar(100),
@phai Nvarchar(10),
@diachi Nvarchar(100),
@ngaysinh Nvarchar(100),
...
if(@ma = 0)
	begin
		select MaPhong, (TienPhong + ChiPhiPhu) as tt
