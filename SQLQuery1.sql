...
insert into DichVu(TenDv, Gia) values(N'Sữa Chua', 6000)
...
insert into game(ma, Cauhoi, Dapan) values (1 ,N'1 + 1 = 2', N'đúng')
insert into game(ma, Cauhoi, Dapan) values (2 ,N'1 + 1 = 1', N'sai')
insert into game(ma, Cauhoi, Dapan) values (3 ,N'2 + 1 = 3', N'đúng')
insert into game(ma, Cauhoi, Dapan) values (4 ,N'2 + 1 = 2', N'sai')
insert into game(ma, Cauhoi, Dapan) values (5 ,N'3 + 1 = 4', N'đúng')
insert into game(ma, Cauhoi, Dapan) values (6 ,N'3 + 1 = 3', N'sai')
insert into game(ma, Cauhoi, Dapan) values (7 ,N'1 - 1 = 0', N'đúng')
insert into game(ma, Cauhoi, Dapan) values (8 ,N'1 - 1 = 1', N'sai')
insert into game(ma, Cauhoi, Dapan) values (9 ,N'2 - 1 = 1', N'đúng')
insert into game(ma, Cauhoi, Dapan) values (10 ,N'2 - 1 = 0', N'sai')
insert into game(ma, Cauhoi, Dapan) values (11 ,N'3 - 1 = 2', N'đúng')
insert into game(ma, Cauhoi, Dapan) values (12 ,N'3 - 1 = 1', N'sai')
insert into game(ma, Cauhoi, Dapan) values (13 ,N'1 + 2 = 3', N'đúng')
insert into game(ma, Cauhoi, Dapan) values (14 ,N'1 + 3 = 2', N'sai')
insert into game(ma, Cauhoi, Dapan) values (15 ,N'2 + 2 = 4', N'đúng')
insert into game(ma, Cauhoi, Dapan) values (16 ,N'2 + 2 = 2', N'sai')
insert into game(ma, Cauhoi, Dapan) values (17 ,N'3 + 2 = 5', N'đúng')
insert into game(ma, Cauhoi, Dapan) values (18 ,N'3 + 2 = 2', N'sai')
insert into game(ma, Cauhoi, Dapan) values (19 ,N'3 + 2 = 3', N'sai')
insert into game(ma, Cauhoi, Dapan) values (20 ,N'3 + 3 = 6', N'đúng')
insert into game(ma, Cauhoi, Dapan) values (21 ,N'3 + 3 = 5', N'sai')
insert into game(ma, Cauhoi, Dapan) values (22 ,N'5 + 6 = 1', N'sai')
insert into game(ma, Cauhoi, Dapan) values (23 ,N'2 - 1 = 0', N'sai')
insert into game(ma, Cauhoi, Dapan) values (24 ,N'3 - 1 = 2', N'đúng')
insert into game(ma, Cauhoi, Dapan) values (25 ,N'3 - 1 = 1', N'sai')
insert into game(ma, Cauhoi, Dapan) values (26 ,N'1 + 2 = 3', N'đúng')
insert into game(ma, Cauhoi, Dapan) values (27 ,N'1 + 3 = 2', N'sai')
insert into game(ma, Cauhoi, Dapan) values (28 ,N'2 + 2 = 4', N'đúng')
insert into game(ma, Cauhoi, Dapan) values (29 ,N'2 + 2 = 2', N'sai')
insert into game(ma, Cauhoi, Dapan) values (30 ,N'3 + 2 = 5', N'đúng')
